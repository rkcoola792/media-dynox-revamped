...
const Blog = ({date,heading,subheading,img}) => {
  return (
    <div className="blog flex gap-6 rounded-lg justify-evenly shadow-blog-shadow p-12 my-6 w-[70%] cursor-pointer border border-white hover:border hover:border-red-400 transition duration-300 ease-out hover:ease-in ">
